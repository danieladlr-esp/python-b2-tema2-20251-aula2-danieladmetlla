...
| Apartado | Ejercicios                                                     |
| -------- |----------------------------------------------------------------|
| a. Librerías para trabajo de datos en Python               | [ej2a1](2a/ej2a1.py) [ej2a2](2a/ej2a2.py) [ej2a3](2a/ej2a3.py) |
| b. Captura de datos                                       | [ej2b1](2b/ej2b1.py) [ej2b2](2b/ej2b2.py) [ej2b3](2b/ej2b3.py) |
| c. Preprocesamiento de datos                              | [ej2c1](2c/ej2c1.py) [ej2c2](2c/ej2c2.py) [ej2c3](2c/ej2c3.py) |
| d. Análisis de datos                                      | [ej2d1](2d/ej2d1.py) [ej2d2](2d/ej2d2.py) [ej2d3](2d/ej2d3.py) |
