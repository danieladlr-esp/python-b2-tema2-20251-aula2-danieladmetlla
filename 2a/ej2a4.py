...
def compare_monthly_sales(sales_year1: list,
                          sales_year2: list,
                          sales_year3: list,
                          months: list) -> t.Tuple[plt.Figure, plt.Axes, plt.Axes]:
    ...
    ax1_twin.plot(months, cumulative_sales_2021, label="Cumulative 2021", color='green', marker='x')
